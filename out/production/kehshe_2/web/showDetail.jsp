...
<% if(loginBean==null){
   ...
   String uri="jdbc:mysql://localhost:3306/1805110209?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&allowPublicKeyRetrieval=true&useSSL=false";
   try{ 
     con=DriverManager.getConnection(uri,"root","ZYB1834257301");
